...
const Header = () => {
    ...
    return (
        <div className="w-screen animated-background h-screen bg-gradient-to-r from-white via-yellow-50 to-yellow-100 
          text-center mx-auto flex flex-col items-center justify-center gap-4 px-4">
          ...
          <p className="text-lg sm:text-xl max-w-2xl mt-2">
          ...
          <button
            ...
            className="mt-6 px-6 py-2 bg-yellow-500 hover:bg-yellow-600 text-black font-medium rounded-lg transition-all shadow"
          >
            Open CV
          </button>
        </div>
