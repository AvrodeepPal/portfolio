...
export default function Skills() {
  return (
    <section id="skills" className="text-center w-full px-[12%] py-20 scroll-mt-0 bg-bg">
      ...
      <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-fg mb-4">Technical Toolbox</h2>
      
      <div className="text-left flex flex-col gap-6 py-6">

        <div>
          <h3 className="text-xl font-semibold mb-4 text-fg">Coding</h3>
        ...
        <div>
          <h3 className="text-xl font-semibold mb-4 text-fg">Development</h3>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-3">
        ...
        <div>
          <h3 className="text-xl font-semibold mb-4 text-fg">Tools</h3>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-3">
        ...
        <div>
          <h3 className="text-xl font-semibold mb-4 text-fg">Technologies</h3>
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-3">
