...
export default function Projects() {
  return (
    <section id="projects" className="text-center w-full px-[12%] py-20 scroll-mt-0">

      <p className="text-base font-semibold uppercase tracking-wide text-[#fdd017]">Projects</p>
      <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-4">Applied Knowledge</h2>
