...
export default function About() {
  return (
    <div id="about" className="bg-white z-20 w-full px-[12%] py-20 scroll-mt-0">
      <p className="text-center text-base font-semibold uppercase tracking-wide text-[#fdd017]">About</p>
      <h2 className="text-center text-3xl sm:text-5xl font-bold tracking-tight text-gray-900 mb-6">My Introduction</h2>
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex flex-1 flex-col gap-6">
          ...
          <div>
            <h4 className="text-2xl font-semibold mb-4 mt-6">My Education</h4>
            ...
            <div className="flex flex-col md:grid grid-cols-12 relative">
              ...
              <div className="flex md:contents">
                ...
                <div className="border-2 border-[#ffe31f] col-start-3 col-end-12 p-4 rounded-xl my-4 mr-auto w-full">
                  ...
                  <p className="text-gray-700">Jadavpur University, Kolkata</p>
                  <p className="text-sm text-gray-600">CGPA (upto 1st sem): <strong>8.33</strong></p>
                </div>
              </div>
              ...
              <div className="flex md:contents">
                ...
                <div className="border-2 border-[#ffe31f] col-start-3 col-end-12 p-4 rounded-xl my-4 mr-auto w-full">
                  ...
                  <p className="text-sm text-gray-600">CGPA: <strong>9.91</strong></p>
                </div>
              </div>
              ...
              <div className="flex md:contents">
                ...
                <div className="border-2 border-[#ffe31f] col-start-3 col-end-12 p-4 rounded-xl my-4 mr-auto w-full">
                  ...
                  <p className="text-gray-700">Score: <strong>95.75%</strong></p>
                </div>
              </div>
              ...
              <div className="flex md:contents">
                ...
                <div className="border-2 border-[#ffe31f] col-start-3 col-end-12 p-4 rounded-xl my-4 mr-auto w-full">
                  ...
                  <p className="text-gray-700">Score: <strong>91.80%</strong></p>
                </div>
              </div>
